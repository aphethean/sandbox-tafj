...
import com.sandbox.tafjeemix.demojar.BaseEntity;
...
public class SchoolJpaDao implements SchoolDao {
	...
	public String getDataStatus() {
		try {
			return dataFactory.getDataMessage();
	...
	/* (non-Javadoc)
	 * @see com.sandbox.demo.bean.SchoolDao#searchStudents(com.sandbox.demo.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
